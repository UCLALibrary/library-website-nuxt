...
export default {
  components: {
    ...
    IllustrationDatabases: () => import("~/assets/svg/illustration-databases"),
    IllustrationDigitizedResources: () =>
      import("~/assets/svg/illustration-digitized-resources"),
    IllustrationFindSpace: () => import("~/assets/svg/illustration-find-space"),
    IllustrationRemoteAccess: () =>
      import("~/assets/svg/illustration-remote-access"),
    IllustrationResearch: () => import("~/assets/svg/illustration-research"),
    IllustrationTeaching: () => import("~/assets/svg/illustration-teaching"),
  },
  props: {
    iconName: {
      type: String,
